<div class="blog-content blog-post-<?php echo esc_attr($showcase_id); ?> main-container blog-full-image-style<?php if ($blog_post_link_post == 'lightbox') { ?> lightbox-parent<?php } ?>">
	...
	if (in_array('advanced-masonry-blog-layout-design/advanced-masonry-blog-layout-design.php', apply_filters('active_plugins', get_option('active_plugins')))) {
		...
		ambld_ta_filter_masonry_temp($use_filter, $blog_layout_showcase_cats, $blog_layout_select_display_post);
	} ?>
...
<?php
if(in_array('advanced-masonry-blog-layout-design/advanced-masonry-blog-layout-design.php', apply_filters('active_plugins', get_option('active_plugins')))){
	wp_enqueue_script( 'ambld-advanced-masonry-blog-layout-design-isotope', ADVANCED_MASONRY_BLOG_LAYOUT_DESIGN_URL . 'assets/js/isotope.min.js', array('jquery', 'imagesloaded'), '', false );
	wp_enqueue_script( 'ambld-advanced-masonry-blog-layout-design-infinite-scroll',  ADVANCED_MASONRY_BLOG_LAYOUT_DESIGN_URL . 'assets/js/infinite-scroll.min.js', array('masonry'), '', false );

	if ($blog_post_link_post == 'lightbox') {
		wp_enqueue_style( 'ambld-advanced-masonry-blog-layout-design-light-gallery', ADVANCED_MASONRY_BLOG_LAYOUT_DESIGN_URL . 'assets/css/lightgallery.css', array(), '', 'all' );
		wp_enqueue_script( 'ambld-advanced-masonry-blog-layout-design-light-gallery',  ADVANCED_MASONRY_BLOG_LAYOUT_DESIGN_URL . 'assets/js/lightgallery.js', array('jquery'), '', false );
	}
}
else {
...
if(class_exists('Elementor\Plugin')) {
	...
	<?php }
		if (in_array('advanced-masonry-blog-layout-design/advanced-masonry-blog-layout-design.php', apply_filters('active_plugins', get_option('active_plugins')))) {
			ambld_ta_filter_masonry_script($showcase_id, $use_filter, $blog_layout_pagination_type);
		}
	}
}
else { ?>
