...
// WP_Query arguments
	$args = array (
		'p'              => $blog_layout_design_select_showcase_post,     // GET POST BY SLUG  // IGNORE IF YOU ARE GETTING ERROR ON THIS LINE IN YOUR EDITOR
	...
	// The Loop
	if ( $query->have_posts() && $blog_layout_design_select_showcase_post != '' ) {
		...
		while ( $query->have_posts() ) {
			...
			if ( $ta_blog_loop->have_posts() ) :
				...
				if($blog_style == 'grid-full-image-1') {
					$portfolio_style_part = BLOG_LAYOUT_DESIGN_DIR .'/public/blog-layout-styles/grid-full-image-1.php';
				}
				elseif($blog_style == 'grid-card-1') {
					$portfolio_style_part = BLOG_LAYOUT_DESIGN_DIR .'/public/blog-layout-styles/grid-card-1.php';
				}
				...
				elseif($blog_style == 'masonry-full-image-1') {
					$portfolio_style_part = BLOG_LAYOUT_DESIGN_DIR .'/public/blog-layout-styles/masonry-full-image-1.php';
				}
				elseif($blog_style == 'masonry-card-1') {
					$portfolio_style_part = BLOG_LAYOUT_DESIGN_DIR .'/public/blog-layout-styles/masonry-card-1.php';
				}
				...
				elseif($blog_style == 'carousel-full-image-1') {
					$portfolio_style_part = BLOG_LAYOUT_DESIGN_DIR .'/public/blog-layout-styles/carousel-full-image-1.php';
				}
				...
				elseif($blog_style == 'slider-full-image-1') {
					$portfolio_style_part = BLOG_LAYOUT_DESIGN_DIR .'/public/blog-layout-styles/slider-full-image-1.php';
				}
				...
				elseif($blog_style == 'justified-full-image-1') {
					$portfolio_style_part = BLOG_LAYOUT_DESIGN_DIR .'/public/blog-layout-styles/justified-full-image-1.php';
				}
